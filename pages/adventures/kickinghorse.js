    ...
    <>
      ...
      <AdventureHeadingStyles>
        ...
        <div className="pContainer">
          ...
          <p>
            The Golden Eagle Express Gondola takes you on a climb to a ridge
            overlooking 3 mountain ranges. You’ll spot wildlife and may even get
            a glimpse of Kicking Horse Mountain Resort’s resident grizzly bear!
            Once at the summit, you can explore the many ridges and bowls by
            foot providing stunning views of the surrounding Purcell and Rocky
            Mountains. If your feeling the need for speed, try your skills on
            some of Canada's most spectacular downhill tracks operated by the
            resort.
          </p>
        </div>
      </AdventureHeadingStyles>
      ...
      <BookAdventureStyles>
        ...
        <div className="twoCol">
          ...
          <div className="right">
            <p>
              Take a trip above the clouds as you ascend to 7,700 feet. Take in
              panoramic views of the Rocky Mountains, the Columbia River
              Wetlands and the town of Golden.
            </p>
            <ul>
              <li>
      ...
      <BookAdventureStyles grey={true}>
        ...
        <div className="twoCol">
          ...
          <div className="right">
            <p>
              Get a guided tour to the home of local celebrity Boo the Bear at
              his Grizzly Bear Refuge and scale the mountain on the Golden Eagle
              Express Gondola for Epic views of the columbia wetland, the town
              of Golden and surrounding Rocky Mountains.
            </p>
            <ul>
              <li>
                <img src="/svg/checkmark.svg" width="15" />
      ...
      <BookAdventureStyles marginBottom={true}>
        ...
        <div className="twoCol">
          ...
          <div className="right">
            <p>
              Take on the Rocky Mountains and bike some of Canada's most epic
              trails! This mountain caters for all riders, includes Golden Eagle
              Gondola and Catamount Chair. Optional bike and gear rental can be
              arranged on site.
            </p>
            <ul>
              <li>
