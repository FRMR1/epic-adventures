...
const SkydivingRafting = () => {
    return (
        <>
            <Head>
                <title>Epic Adventures | Skydiving/Rafting</title>
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <HeroImageStyles>
                <div className="heroText">
                    <h2>Skydiving/Rafting.</h2>
                </div>
                <div className="heroText">
                    <h2 className="bg">Skydiving/Rafting.</h2>
                </div>
            </HeroImageStyles>
            <TopDividerStyles>
...
export default SkydivingRafting
